...
def go(args):
    ...
    logger.info("Train data sucessfully fitted")
    ######################################
    ...
    ######################################
    # Save the sk_pipe pipeline as a mlflow.sklearn model in the directory "model_dir"
    # HINT: use mlflow.sklearn.save_model
    mlflow.sklearn.save_model(sk_pipe, model_dir)
    logger.info("Fitted model stored localy")
    ######################################
    ...
    artifact = wandb.Artifact(args.output_artifact, type="model_export", description="random forest trained model")
    artifact.metadata.update(rf_config)
    artifact.add_dir(model_dir)
    run.log_artifact(artifact)
    logger.info("Fitted model stored remotely as artifact")
    ######################################
